...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      // grafoLista['a'] = new Retangulo(mundo, ref rotuloAtual)
      // {
      //   PrimitivaTipo = PrimitiveType.Lines
      // };

      // grafoLista['b'] = new Retangulo(mundo, ref rotuloAtual)
      // {
      //   PrimitivaTipo = PrimitiveType.LineLoop
      // };
      
      // grafoLista['c'] = new Retangulo(mundo, ref rotuloAtual)
      // {
      //   PrimitivaTipo = PrimitiveType.LineStrip
      // };
      
      // grafoLista['d'] = new Retangulo(mundo, ref rotuloAtual)
      // {
      //   PrimitivaTipo = PrimitiveType.Triangles
      // };
      
      // grafoLista['e'] = new Retangulo(mundo, ref rotuloAtual)
      // {
      //   PrimitivaTipo = PrimitiveType.TriangleStrip
      // };
      
      // grafoLista['f'] = new Retangulo(mundo, ref rotuloAtual)
      // {
    ...
    protected override void OnUpdateFrame(FrameEventArgs e)
    {
      ...
      if (estadoTeclado.IsKeyPressed(Keys.Space))
        objetoSelecionado.PrimitivaTipo = (objetoSelecionado.PrimitivaTipo >= PrimitiveType.TriangleFan) ? PrimitiveType.Points : objetoSelecionado.PrimitivaTipo += 1;
